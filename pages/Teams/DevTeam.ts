...
export class DevTeams{
    ...
    readonly AddMember1:Locator;
    readonly AddMember2:Locator;
    readonly AddMember3:Locator;
    ...
    constructor(page: Page){
        ...
        this.AddMember1=page.locator('text=Revathi chandra (User)');
        this.AddMember2=page.locator('text=chandra babu (User)');
        this.AddMember3=page.locator('span:has-text("chandradt@mailinator.com (User)")');

    }


    
    async CreatingDevGroupInTeams(){
    ...
    async EnterDataOnProcessName(){
        await this.ProcessName.fill('QaRole1234')
        }
       ...
       async clickOnConfiguration(){
        ...
        //await this.AddMember1.click();
        //await this.AddMember2.click();
        //await this.AddMember3.click();
