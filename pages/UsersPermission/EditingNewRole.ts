...
export class EditingNewRoleInUserAndPermission{
    readonly page: Page;
    ...
    constructor(page: Page){
        ...
        this.selectEdit=page.locator('text=Edit >> nth=1');
