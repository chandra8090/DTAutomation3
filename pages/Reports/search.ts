...
export class SearchReport{
    ...
    readonly validatingSearchPage:Locator;
    ...
    constructor(page: Page){
        ...
        this.validatingSearchPage=page.locator('button:has-text("Create Report")');
        this.btnProfile=page.locator('div.avatarProfile');
        this.bthLogout=page.locator('text=Log Out');

    }

    async searchingAReport(){
        ...
        await this.clickOnSearchBox();
        await this.ValidatingSearchText();
    ...
    async clickOnSearchBox(){
        await this.searchBox.fill('test');
    }
    async ValidatingSearchText(){
        await this.validatingSearchPage.isVisible();
    }
