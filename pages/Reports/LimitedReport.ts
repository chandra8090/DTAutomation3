...
export class CreateLimitedReport{
    readonly page: Page;
    ...
    readonly LimitedSelceted:Locator;
    ...
    constructor(page: Page){
        ...
        this.LimitedSelceted=page.locator('text=limited');
    ...
    async clickOnCreateButton(){
        ...
        await this.LimitedSelceted.click();
