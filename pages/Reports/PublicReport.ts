...
export class CreatePublicReport{
    readonly page: Page;
    ...
    constructor(page: Page){
        ...
        this.publicSelcet=page.locator('ul[role="listbox"] div:has-text("public")');
